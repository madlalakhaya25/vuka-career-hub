...
const bursaries = [
  {
    ...
    amount: 'Full tuition + accommodation + R5,200/month living allowance',
  ...
  },
  {
    ...
    eligibility: 'B.Ed at an approved university (PGCE not funded in 2026). Work-back obligation: teach at a public school. Priority: Maths, Physical Sciences, Computer Applications Technology, Agricultural Sciences, African Languages.',
  ...
  },
  {
    ...
    amount: 'Tuition + living allowance + psychosocial support',
    deadline: '2027-05-31', applicationUrl: 'https://www.sasol.com/careers/bursaries',
    ...
    fields: ['Engineering', 'Science', 'Mathematics', 'Statistics', 'Data Science'],
