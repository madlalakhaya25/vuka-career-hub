...
const institutions = [
  ...
  { name: 'UKZN', type: 'UNIVERSITY', provinces: ['KwaZulu-Natal'], city: 'Durban / PMB', website: 'https://www.ukzn.ac.za', nsfas: true, desc: 'Large comprehensive university with strong healthcare and engineering programmes.', appClose: 'Sep 2025', featured: false, rank: undefined },
  ...
  { name: 'Tshwane University of Technology (TUT)', type: 'UNIVERSITY', provinces: ['Gauteng'], city: 'Pretoria', website: 'https://www.tut.ac.za', nsfas: true, desc: "SA's largest contact university. Practical IT, engineering, and business programmes.", appClose: 'Oct 2025', featured: false, rank: undefined },
  ...
  { name: 'Majuba TVET College', type: 'TVET', provinces: ['KwaZulu-Natal'], city: 'Newcastle', website: 'https://www.majuba.edu.za', nsfas: true, desc: 'Quality TVET college in northern KZN. Engineering, business, and IT.', appClose: 'Jan 2026', featured: false, rank: undefined },
  { name: 'West Coast TVET College', type: 'TVET', provinces: ['Western Cape'], city: 'Vredenburg', website: 'https://www.westcoastcollege.co.za', nsfas: true, desc: 'TVET college serving the West Coast with NCV and NATED programmes.', appClose: 'Jan 2026', featured: false, rank: undefined },
  ...
  { name: 'Boston City Campus', type: 'PRIVATE_COLLEGE', provinces: ['Gauteng', 'Western Cape', 'Eastern Cape'], city: 'Multiple campuses', website: 'https://www.boston.co.za', nsfas: false, desc: "One of SA's oldest private colleges. Career-focused diplomas and certificates.", appClose: 'Rolling', featured: false, rank: undefined },
