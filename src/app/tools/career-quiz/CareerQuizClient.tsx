...
const questions = [
  ...
  },
  {
    ...
    options: [
      { text: 'Highest possible salary — I want to earn top money', traits: ['it', 'finance', 'engineering'] },
  ...
  },
  {
    ...
    options: [
      { text: 'Someone should fix the grid — I want to be that person', traits: ['engineering', 'trades'] },
      { text: 'Solar energy is the future — I want to install it', traits: ['trades', 'renewable'] },
