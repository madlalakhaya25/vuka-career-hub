...
async function main() {
  ...
  const learnerships = [
    {
      ...
      deadline: new Date('2026-09-30'), provinces: ['National'], isNational: true, status: 'OPEN' as const,
    ...
    },
    {
      ...
      deadline: new Date('2026-08-31'), provinces: ['Gauteng', 'KwaZulu-Natal', 'Western Cape'], isNational: false, status: 'OPEN' as const,
    ...
    },
    {
      ...
      deadline: new Date('2026-10-15'), provinces: ['National'], isNational: true, status: 'OPEN' as const,
      requirements: 'Grade 12',
      description: 'Business administration, customer service, and office management skills.',
      icon: '📋', fieldOfStudy: 'Business & Commerce',
      applicationUrl: 'https://www.serviceseta.org.za/learnerships',
    },
    {
      ...
      deadline: new Date('2026-11-30'), provinces: ['Limpopo', 'Gauteng', 'Free State'], isNational: false, status: 'OPEN' as const,
      ...
      applicationUrl: 'https://www.ewseta.org.za/learnerships',
    },
    {
      ...
      deadline: new Date('2026-09-15'), provinces: ['National'], isNational: true, status: 'OPEN' as const,
      ...
      applicationUrl: 'https://www.hwseta.org.za/learnerships',
    },
    {
      title: 'Digital Marketing Learnership',
      provider: 'MICT SETA', seta: 'MICT SETA', sector: 'Marketing & Media',
      nqfLevel: 4, stipendMin: 3000, stipendMax: 4500, durationMonths: 12,
      deadline: new Date('2026-10-31'), provinces: ['National'], isNational: true, status: 'OPEN' as const,
      requirements: 'Grade 12',
    ...
    },
    {
      ...
      deadline: new Date('2026-07-31'), provinces: ['Gauteng', 'Mpumalanga', 'KwaZulu-Natal'], isNational: false, status: 'OPEN' as const,
    ...
    },
    {
      ...
      deadline: new Date('2026-08-31'), provinces: ['National'], isNational: true, status: 'OPEN' as const,
      ...
      applicationUrl: 'https://www.fasset.org.za/learnerships',
    },
  ]
  ...
  const bursaries = [
    {
      ...
      deadline: null, applicationUrl: 'https://my.nsfas.org.za',
      eligibilityNotes: 'SA citizen, household income ≤ R350K/yr. SASSA auto-qualifies. Public universities & TVET only. Applications for 2027 expected to open Sep–Oct 2026 — monitor nsfas.org.za.',
    ...
    },
    {
      ...
      deadline: null, applicationUrl: 'https://www.funzalushaka.doe.gov.za',
      eligibilityNotes: 'B.Ed at an approved university (PGCE not funded). Work-back obligation: teach at a public school. Priority: Maths, Physical Sciences, CAT, Agricultural Sciences, African Languages. 2027 applications expected to open around October 2026.',
    ...
    {
      name: 'Sasol Bursary',
      fullName: 'Sasol Mainstream Bursary Programme',
      provider: 'Sasol', category: 'corporate',
      icon: '⚗️', featured: true,
      amountDescription: 'Tuition + living allowance + vacation work',
      deadline: new Date('2026-05-17'), applicationUrl: 'https://www.sasolbursaries.com',
      eligibilityNotes: 'SA citizen. First-year Engineering or Science student at a public SA university. Mathematics & Physical Science required. Results notifications: end of September 2026.',
      description: "One of SA's most prestigious corporate bursaries. The 2027 academic year cycle (1 Apr – 17 May 2026) has now closed. Monitor sasolbursaries.com for the 2028 cycle opening around April 2027.",
      fieldsOfStudy: ['Engineering', 'Science', 'Chemistry', 'Mathematics', 'Statistics'],
      isNsfas: false, isActive: true,
    },
    {
      name: 'Anglo American',
      ...
      amountDescription: 'Full tuition + living allowance + vacation work',
      deadline: null, applicationUrl: 'https://southafrica.angloamerican.com/careers/graduates-and-bursaries',
      eligibilityNotes: 'SA citizen. Good academic record at a recognised SA university. Note: Anglo American Platinum, Kumba Iron Ore, and Coal each have separate bursary programmes — check each business unit\'s page.',
      description: 'Anglo American funds students in mining, engineering, and geosciences across its SA business units. Includes vacation work at operations. 2027 application dates not yet published — check from mid-2026.',
      fieldsOfStudy: ['Mining Engineering', 'Metallurgy', 'Mechanical Engineering', 'Geology', 'Chemical Engineering'],
      isNsfas: false, isActive: true,
    },
    {
      name: 'Eskom Bursary',
      ...
      icon: '⚡', featured: false,
      amountDescription: 'Full tuition + monthly allowance + vacation work',
      deadline: null, applicationUrl: 'https://www.eskom.co.za/careers/students/',
      eligibilityNotes: 'SA citizen. Min 60% in Maths & Physical Science. Fields: Electrical, Mechanical, Chemical, Civil, Industrial Engineering. 200 bursaries awarded annually. 2027 applications expected Aug–Oct 2026.',
      description: 'Eskom funds engineering students with a strong prospect of employment after graduation. 2027 application dates not yet published — monitor eskom.co.za/careers/students from August 2026.',
      fieldsOfStudy: ['Electrical Engineering', 'Mechanical Engineering', 'Civil Engineering', 'Chemical Engineering', 'Industrial Engineering'],
      isNsfas: false, isActive: true,
    },
    {
      name: 'Standard Bank',
      ...
      deadline: new Date('2026-09-30'), applicationUrl: 'https://studytrust.org.za/standardbank/',
      eligibilityNotes: 'SA citizen. Min 65% average. Fields: Commerce, Engineering, Science, Actuarial, Analytics, Data Science, IT, Financial Technology. Apply via StudyTrust — not the Standard Bank website directly.',
      description: 'Full bursary for 2027 academic year. Applications open June 2026 and close 30 September 2026. Managed through StudyTrust. Includes mentorship and graduate employment pathway.',
      fieldsOfStudy: ['Commerce', 'Accounting', 'IT', 'Data Science', 'Finance', 'Actuarial Science', 'Engineering'],
      isNsfas: false, isActive: true,
    },
    {
      name: 'MICT SETA',
      ...
      deadline: null, applicationUrl: 'https://www.mict.org.za/bursaries/',
      eligibilityNotes: 'SA citizen. Enrolled in an ICT qualification. Applications typically routed through your institution\'s financial aid office. Check mict.org.za for current Discretionary Grant window announcements.',
      description: 'MICT SETA funds ICT students at universities, private colleges, and TVET colleges. Useful for students who do not qualify for NSFAS. Current 2027-cycle dates not yet published.',
      fieldsOfStudy: ['Information Technology', 'Software Development', 'Cybersecurity', 'Data Science', 'Digital Media'],
      isNsfas: false, isActive: true,
    },
    {
      name: 'MERSETA',
      ...
      deadline: null, applicationUrl: 'https://www.merseta.org.za/form/',
      eligibilityNotes: 'SA citizen. Manufacturing or engineering sector. Applications typically processed through your university or TVET financial aid office — check with them for internal deadlines. 2027-cycle dates not yet announced.',
      description: 'MERSETA funds engineering and manufacturing students at universities and TVET colleges. The 2026-cycle closed in February 2026. Monitor merseta.org.za for the 2027 cycle announcement.',
      fieldsOfStudy: ['Mechanical Engineering', 'Electrical Engineering', 'Manufacturing', 'Metallurgy', 'Automotive'],
      isNsfas: false, isActive: true,
    },
  ]
  ...
  const institutions = [
    { name: 'University of Cape Town (UCT)', type: 'UNIVERSITY' as const, provinces: ['Western Cape'], city: 'Cape Town', website: 'https://www.uct.ac.za', nsfasAccredited: true, description: "Africa's top-ranked university. Strong in law, medicine, commerce, and engineering.", appCloseDisplay: 'Jul 2026', applicationCloseDate: new Date('2026-07-31'), featured: true, rank: '1st in Africa' },
    { name: 'University of the Witwatersrand (Wits)', type: 'UNIVERSITY' as const, provinces: ['Gauteng'], city: 'Johannesburg', website: 'https://www.wits.ac.za', nsfasAccredited: true, description: 'Premier research university in Johannesburg. Renowned for medicine, engineering, and law. Note: Health Sciences and some faculties close 30 June.', appCloseDisplay: 'Sep 2026', applicationCloseDate: new Date('2026-09-30'), featured: true, rank: 'Top 5 SA' },
    { name: 'University of Pretoria (UP)', type: 'UNIVERSITY' as const, provinces: ['Gauteng'], city: 'Pretoria', website: 'https://www.up.ac.za', nsfasAccredited: true, description: "One of SA's largest universities. Strong in veterinary science, law, and engineering. Vet Science closes 31 May.", appCloseDisplay: 'Jun 2026', applicationCloseDate: new Date('2026-06-30'), featured: false },
    { name: 'Stellenbosch University', type: 'UNIVERSITY' as const, provinces: ['Western Cape'], city: 'Stellenbosch', website: 'https://www.sun.ac.za', nsfasAccredited: true, description: 'Top research university. Strong in agriculture, data science, and engineering. Some Science faculties close later — verify per faculty.', appCloseDisplay: 'Jul 2026', applicationCloseDate: new Date('2026-07-31'), featured: false },
    { name: 'UKZN', type: 'UNIVERSITY' as const, provinces: ['KwaZulu-Natal'], city: 'Durban / PMB', website: 'https://www.ukzn.ac.za', nsfasAccredited: true, description: 'Two campuses in Durban and Pietermaritzburg. Well known for healthcare, engineering, and agriculture.', appCloseDisplay: 'Check website', applicationCloseDate: null, featured: false },
    { name: 'UNISA', type: 'DISTANCE_LEARNING' as const, provinces: ['National'], city: 'Distance learning', website: 'https://www.unisa.ac.za', nsfasAccredited: true, description: "Africa's largest university. Fully online — study from anywhere in SA or the world. 2027 Semester 1 applications expected to open around August 2026.", appCloseDisplay: '~Oct 2026', applicationCloseDate: null, featured: true, rank: 'Largest in Africa' },
    { name: 'Tshwane University of Technology (TUT)', type: 'UNIVERSITY' as const, provinces: ['Gauteng'], city: 'Pretoria', website: 'https://www.tut.ac.za', nsfasAccredited: true, description: "One of SA's largest universities by student numbers. Practical, hands-on degrees in IT, engineering, and business.", appCloseDisplay: 'Check website', applicationCloseDate: null, featured: false },
    { name: 'Durban University of Technology (DUT)', type: 'UNIVERSITY' as const, provinces: ['KwaZulu-Natal'], city: 'Durban', website: 'https://www.dut.ac.za', nsfasAccredited: true, description: 'Strong engineering, IT, management, and health sciences in KZN.', appCloseDisplay: 'Check website', applicationCloseDate: null, featured: false },
    { name: 'Tshwane North TVET College', type: 'TVET' as const, provinces: ['Gauteng'], city: 'Pretoria', website: 'https://www.tnc.edu.za', nsfasAccredited: true, description: "One of Gauteng's largest TVET colleges. NCV and NATED in engineering, IT, and business.", appCloseDisplay: 'Rolling', applicationCloseDate: null, featured: true },
    { name: 'Northlink TVET College', type: 'TVET' as const, provinces: ['Western Cape'], city: 'Bellville', website: 'https://www.northlink.edu.za', nsfasAccredited: true, description: 'Leading TVET college in the Western Cape. Trades, IT, business, and hospitality.', appCloseDisplay: 'Rolling', applicationCloseDate: null, featured: false },
    { name: 'Majuba TVET College', type: 'TVET' as const, provinces: ['KwaZulu-Natal'], city: 'Newcastle', website: 'https://www.majuba.edu.za', nsfasAccredited: true, description: 'Well-regarded TVET college in the Newcastle area. Strong in engineering trades, IT, and business.', appCloseDisplay: 'Rolling', applicationCloseDate: null, featured: false },
    { name: 'West Coast TVET College', type: 'TVET' as const, provinces: ['Western Cape'], city: 'Vredenburg', website: 'https://www.westcoastcollege.co.za', nsfasAccredited: true, description: 'Main TVET option along the West Coast. Offers NCV and NATED in trades, business, and engineering.', appCloseDisplay: 'Rolling', applicationCloseDate: null, featured: false },
